...
<body>
    <div class="container">
        ...
        <form method="post" class="cidade" action="../Controller/cidade.php">
            <h1>Editar Cidade</h1>
            <input type="text" class="nome_cidade" name="nome_antigo_cidade" placeholder="Nome Antigo da Cidade">
            <input type="text" class="nome_cidade" name="nome_novo_cidade" placeholder="Nome Novo da Cidade">
